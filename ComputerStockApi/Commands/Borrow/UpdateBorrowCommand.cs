...
namespace ComputerStockApi.Commands.Borrow
{
    ...
    public class UpdateBorrowComputerCommandHandler : IRequestHandler<UpdateBorrowCommand>
    {
        public readonly IMapper mapper;
        public readonly ComputerStockContext _context;

        public UpdateBorrowComputerCommandHandler(IMapper map, IConfiguration config)
        {
